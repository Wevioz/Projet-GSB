...
<form method="POST" action="index.php?uc=suivreFiche&action=suivieFicheFrais">
    ...
    <table class="listeLegere">
         ...
         <tr>
              <td><input type="checkbox" name="checkbox[]" value="<?php echo $visiteur['mois'].$visiteur['etat'].$visiteur['id']?>"></td>
                ...
                <td><a href="index.php?uc=suivreFiche&action=voirDetailFiche&visiteur=<?php echo $visiteur['id'] ?>&mois=<?php echo $visiteur['mois'] ?>">Consulter</a></td>
